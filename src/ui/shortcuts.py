...
from src.core.system.shortcuts import WindowsShortcuts
    ...
    def __init__(self, master, title, shortcuts):
        ...
        for i, shortcut in enumerate(shortcuts):
            btn = ctk.CTkButton(
                ...
                text=shortcut["name"],
                width=200,
                command=lambda cmd=shortcut["command"], adm=shortcut.get("admin", False):
                    WindowsShortcuts.launch_shortcut(cmd, adm)
            )
