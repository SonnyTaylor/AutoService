...
export function initCamera() {
  ...
  cameraState.placeholder = qs("#camera-placeholder");
  ...
  // Initialize UI state
  if (cameraState.placeholder) cameraState.placeholder.style.display = "flex";
  if (cameraState.video) cameraState.video.style.display = "none";
...
async function startCamera() {
  try {
    ...
    cameraState.camStream = await navigator.mediaDevices.getUserMedia(
      constraints
    );
    ...
    if (cameraState.placeholder) cameraState.placeholder.style.display = "none";
    if (cameraState.video) cameraState.video.style.display = "block";
